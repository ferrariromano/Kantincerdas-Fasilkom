        ...
        <main>
            <header class="headline flex-group">
                <picture class="headline__img">
                    <img src="images/img/fasilkom.png" alt="fasilkom">
                </picture>
                <div class="headline__text">
                    ...
                    <div class="headline__btn flex-group">
                        <button class="button btn_view">Lihat Outlet <img class="arrow" src="images/icon/arrow_icon.png" alt="arrow_icon"></button>
                        <button class="button btn_order">Pesan Sekarang</button>
                    </div>
                </div>
            </header>
            ...
            <div class="offer flex-group">
                <div class="offer__icon flex-group">
                    <img class="icon" src="images/icon/check_icon.png" alt="order_icon">
                    <div class="icon_text">
                        <h3>Pesan Online</h3>
                ...
                <div class="offer__icon flex-group">
                    <img class="icon" src="images/icon/payment_icon.png" alt="payment_icon">
                    <div class="icon_text"> 
                        <h3>Bayar Mudah</h3>
                ...
                <div class="offer__icon flex-group">
                    <img class="icon" src="images/icon/food_icon.png" alt="food_icon">
                    <div class="icon_text">
            ...
            <section class="bestseller">
                ...
                <div class="bestseller__menu flex-group">
                    <div class="bestseller__item">
                        <img src="images/img/food1.png" alt="food1">
                        <span class="bestseller__text">Soto Sate</span>
                        <a href="#">Pesan ></a>
                    </div>
                    <div class="bestseller__item">
                        <img src="images/img/food2.png" alt="food2">
                        <span class="bestseller__text">Ayam Geprek</span>
                        <a href="#">Pesan ></a>
                    </div>
                    <div class="bestseller__item">
                        <img src="images/img/food3.png" alt="food3">
            ...
            <div class="attachment">
                ...
                <button class="button attachment__btn">Pesan Sekarang <img class="arrow" src="images/icon/arrow_icon.png" alt="arrow_icon"></button>
            </div>
        </main>    
    </div>
@endsection