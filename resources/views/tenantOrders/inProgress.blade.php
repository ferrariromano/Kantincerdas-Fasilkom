                            ...
                            @foreach($orders as $items)
                                <tr>
                                    ...
                                    <td class="px-3.5 py-2.5 border-y border-slate-200 dark:border-zinc-500">
                                        <span class="px-2.5 py-0.5 inline-block text-xs font-medium rounded border bg-blue-100 border-blue-200 text-blue-500 dark:bg-blue-500/20 dark:border-blue-500/20">
                                            In Progress
                                        </span>
                                    </td>
                                    <td class="px-3.5 py-2.5 border-y border-slate-200 dark:border-zink-500">
